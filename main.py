...
# Train and Test list
tr_list = np.loadtxt('./train/train', dtype=str, delimiter=',')
val_list = np.loadtxt('./train/val', dtype=str, delimiter=',')
# Initialize dataset
train_db = CpscDataset(root_dir='/home/meng/projects/dataset/cpsc/',
                       record_list=tr_list,
                       pre_processing=transforms.Compose([
                           ToTensor()
                       ]))
val_db = CpscDataset(root_dir='/home/meng/projects/dataset/cpsc/',
